...
@OpenAPIDefinition(
    info = Info(
        title = "Supervision Packages API",
        contact = Contact(
            name = "Probation Integration Team",
            email = "probation-integration@JusticeUK.onmicrosoft.com",
            url = "https://moj.enterprise.slack.com/archives/C02QSERFGMB" // #probation-integration-team Slack channel
        ),
        license = License(
            name = "MIT",
            url = "https://github.com/ministryofjustice/hmpps-supervision/blob/main/LICENSE"
        ),
        version = "1.0"
    ),
    servers = [Server(url = "/")],
